<template>
  <div class="fixed bottom-4 right-4 z-40 flex flex-col gap-3 max-w-sm pointer-events-none">
    <!-- Task Notifications -->
    <div
      v-if="taskStore.upcomingTasks.length > 0 && !dismissedTasks"
      class="bg-elevated border border-yellow-200 dark:border-yellow-500/40 rounded-lg shadow-lg p-4 pointer-events-auto"
    >
    ...
    <div
      ...
      class="bg-elevated border border-blue-200 dark:border-blue-500/40 rounded-lg shadow-lg p-4 pointer-events-auto"
    >
      <div class="flex items-start">
        <div class="flex-shrink-0">
